...
var data = [
    "Babe Ruth hit his first home run in Fayetteville on March seventh 1914.",
    "The Venus Fly Trap is only found in two American states, North Carolina and South Carolina, but is native to Hampstead, North Carolina.",
    ...
    "At 480 feet high, Fontana Dam is the tallest dam in the Eastern United States.",
    "The first mini-golf, or Putt Putt golf course, was built in Fayetteville.",
    "The Stanly–Spaight Duel was the most notorious affair of honor in North Carolina history.  The duel occured on the evening of September fifth, 1802 and at the time was part of the southern culture of honor, which compelled elite men to attach life-or-death importance to their reputations.",
    ...
    "Virginia Dare, born on Roanoke Island, was the first English child born on American soil.",
    "The islands off the North Carolina coast practically have their own language known as the High Tider dialect.",
    "In 1961, two nuclear bombs 260 times more powerful than the bomb dropped on Hiroshima were accidentally dropped over Goldsboro,North Carolina.",
    "North Carolina is the “Moonshine Capital of the World” and gave birth to NASCAR.",
    ...
    "The first English settlement in the New World was in North Carolina - The Lost Colony that no one knows what happened to!",
    ...
    "North Carolina boasts the most outdoor dramas of any state, as well as the first outdoor drama, The Lost Colony, which details the first English settlement in the New World.",
    ...
    "The Brown Mountain Lights are a series of ghost lights reported near Brown Mountain in North Carolina. The lights can be seen from the Blue Ridge Parkway at mile posts 310 and 301 and from the Brown Mountain Overlook on North Carolina Highway 181.  Legend holds the lights to be 'ghost maidens' searching for their loved ones after a great battle of The Cherokee and Catawba.",
    "North Carolina was the last state to secede from the Union during the Civil War.",
    ...
    "A colony of Swiss and German Protestants founded New Bern, which is North Carolina’s second oldest town and home of the New Bern bears.",
    ...
    "On November 21, 1789, North Carolina became the twelfth state to join the Union.",
    ...
    "Korner's Folly is an historic home built by Jule Gilmer Korner. Located in Kernersville, North Carolina, it is considered by many as the strangest home in America.",
    ...
    "The Duke Lemur Center in Durham North Carolina is a research center for rare prosimians. The Center is studying how they sleep to help prolong human life.",
    ...
    "Sylva North Carolina is home to the American Museum of the House Cat and includes a petrified cat rescued from a sixteenth century English fireplace.",
    "The Grove Park Inn in Ashville North Carolina is the United States Supreme Court's secret Cold War relocation facility.",
    ...
    "The abandoned Henry River Mill Village served as the filmsite for District Twelve in the the movie The Hunger Games.",
    ...
    "Known as Fish Town in the early 1700's when Blackbeard frequented the North Carolina coast, Beaufort Town was established as a seaport with the right to collect customs in 1722.",
    "Whitewater Falls in Transylvania County is the highest waterfall in the eastern United States.",
    ...
    "The World War Two battleship North Carolina is permanently berthed on the Cape Fear River at Wilmington. She was saved from the scrap heap in the 1960's by public subscription, including donations of dimes by schoolchildren.",
    "The University of North Carolina's mascot, the Tarheels, is a nickname for North Carolinians that supposedly came from the days when North Carolina produced a lot of tar, and someone saw a set of footprints made by someone who had stepped in the tar.",
    ...
    "The official State Dog of North Carolina is the Plott Hound.  The Plott hound is one of only four breeds known to be of American origin and are described as the ninja warriors of dogdom.",
    "North Carolina designated stock car racing as the official state sport in 2011. North Carolina is the home of the stock car racing NASCAR Hall of Fame and the North Carolina Auto Racing Hall of Fame.",
    ...
    "The blossom of the dogwood tree was designated as the official state flower of North Carolina in 1941. The Dogwood is one of the most common trees in North Carolina and its white flowers bloom each Spring.",
    ...
    "In 2010 North Carlina designated the Colonial Spanish Mustang as the official state horse after numerous requests from the students of Shawboro Elementary School in Currituck County.  Although nearly extinct the few remaining populations roam the Outer Banks arround Corolla, North Carolina",
